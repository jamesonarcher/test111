...
export default function App() { 
  const [url, setUrl] = useState('https://demo.mercury.com/dashboard'); 
  ...
  registerNNPushToken(16649, '6L3kz9xddgWKHsyzBFpAUi'); 
  ...
  useEffect(() => { 
    async function getUnreadNots() { 
      let unreadCount = await getUnreadNotificationInboxCount(16649, '6L3kz9xddgWKHsyzBFpAUi'); 
  ...
  const handleGoToInbox = async () => { 
    let notifications = await getNotificationInbox(16649, '6L3kz9xddgWKHsyzBFpAUi'); 
